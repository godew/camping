						...
						<div class="txt policy_01">
							...
							<div class="terms_title">
								...
								<table>
									...
									<tbody>
										<tr>
											<td class="align-center">선택</td>
											<td>서비스 이용, 상담 및 부정 거래 기록 확인</td>
											<td>
												[내 정보 관리]<br>
												-이름<br><br>
												&nbsp;
											...
											<td class="bold-weight">
												- <b><u>회원 탈퇴 요청일로 부터 24시간</u></b> 보관<br>
												- 관계법령에 따라 보존할 필요가 있는 경우&nbsp;<b>관련 법령에서 요구하는 기한까지</b>&nbsp;보관
											</td>
										</tr>
									</tbody>
								</table>
								...
								<ul class="paragraph-info paragraph-info__left">
									<li>- 위 동의 내용을 거부하실 수 있으며, 동의를 거부하시더라도 서비스는 이용하실 수 있습니다.</li>
